...
private function normalize_date($date) {
    ...
    $headers = 'ЕГН, Име, Телефон, Имейл, Факултет, Специалност, Курс, Форма на обучение, Факултетен номер, Рождена дата, Чип на картата, Библиотечен номер, Баркод,  Статус, Грешки'. "\r\n";  
