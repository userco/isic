...
/**
 * php -d memory_limit=2048M app/console data:xmlout:makearchive
 */
...
private function normalize_date($date) {
    ...
    {
        $this
            ->setName('data:xmlout:makearchive')
            ->setDescription('Прави архив с XML файл за валидация в библиотеката');
    }
...
//        $result = $doctrine->getRepository('PriemBundle:Document')->findByIsApproved(1);
